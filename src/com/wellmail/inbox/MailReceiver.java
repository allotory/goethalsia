...
import com.wellmail.bean.OtherMailBean;
...
public class MailReceiver {
	...
	private List<OtherMailBean> otherMailList = new ArrayList<OtherMailBean>();
	OtherMailBean othermailbean = new OtherMailBean();
	...
	private void showMailBasicInfo(Message message) throws Exception {
		...
		othermailbean.setFrom(this.getFrom());
		othermailbean.setSubject(this.getSubject());
		othermailbean.setSentdate(this.getSentDate());
		othermailbean.setNew(this.isNew());
		othermailbean.setHasAttach(this.isContainAttach());
	}
	...
	private void saveMessageAsFile(Message message) {
		try {
			...
			othermailbean.setPath(fileNameWidthExtension);
			otherMailList.add(othermailbean);
			
			othermailbean = null;
			othermailbean = new OtherMailBean();
...
/*
	public static void main(String[] args) throws Exception {
		...
		receiverInfo.setUserName("bauble");
		receiverInfo.setPassword("severus125874693");
		...
		for(Iterator<OtherMailBean> i = receiver.otherMailList.iterator();i.hasNext();) {
	...
	public List<OtherMailBean> getOtherMailList() {
		return otherMailList;
	}

	public void setOtherMailList(List<OtherMailBean> otherMailList) {
		this.otherMailList = otherMailList;
	}
}

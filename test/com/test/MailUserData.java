...
public class MailUserData {
	...
	public void doCreateFolder(String foldername) throws Exception {
		if (foldername == null || foldername.equals(""))
			throw new Exception(
					"You do not input new folder name when creating folder");
		Folder folder = store.getFolder(foldername);
		if (folder.exists())
	...
	public void doRenameFolder(String fromname, String toname) throws Exception {
		...
		if (toname == null || toname.equals(""))
			throw new Exception(
					"You do not input new folder name when renaming folder");
	...
	public Message doAssembleMessage(PMessage msg) throws Exception {
		return doAssembleMessage(msg.getTo(), msg.getCC(), msg.getBCC(), msg
				.getSubject(), msg.getText());
	}

	public Message doAssembleMessage(String to, String cc, String bcc,
			String subj, String text) throws Exception {

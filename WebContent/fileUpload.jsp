...
a.files,a.files input {
	...
	<body style="margin-left: 15px; margin-top: 5px">
		<%
			...
			//System.out.println("filetypeid(fileupload):"+filetypeid);
			request.getSession().setAttribute("sessionfiletypeid", filetypeid);
		%>
		<form id="uploadForm" action="fileutils.jsp">
				...
				<tbody>
					<tr>
						...
						<td>
							...
							<img id="idProcess" style="display: none;"
...
FileUpload.prototype = {
  ...
  SetOptions: function(options) {
    this.options = {//默认值
		...
		ExtIn:		["java","html","jsp","js","pdf","txt","gif","jpg","rar","zip"],//允许后缀名

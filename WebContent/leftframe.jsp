<%@ page language="java" contentType="text/html; charset=GB18030"
	pageEncoding="GB18030" import="com.wellmail.model.*,java.util.*"%>
	...
	<body onload="initinav('系统设置')">
		<div id="left_content">
			<div id="user_info">
				...
				<strong> <logic:present name="user">
						<%
							Users user = (Users) request.getSession().getAttribute("user");
								...
								int np = username.indexOf("@");
								String name = username.substring(0, np);
								out.print(name);
						%>
				...
				[
				<a
					onclick="javascript:changeframe('', '', 'manframe.jsp'); return false;"
					href="#">首页</a>，

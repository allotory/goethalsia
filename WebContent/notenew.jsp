...
-->
	...
	function action1() 
	{ 
	   document.form1.action="savenote.do"; 
	   document.form1.submit(); 
	} 
	function action2() 
	{ 
	   document.form1.action="notebook.jsp"; 
	   document.form1.submit(); 
	} 
</script>
				...
				<tr bgcolor="#f7fdfe" height="35px">
					<td width="100%">
						...
						<input TYPE="BUTTON" ONCLICK="action1()" class="Btn BtnNml"
							value="保存" onMouseDown="this.className='Btn BtnHv BtnDw'"
				...
				<div class="Read_T">
		  		...
		  		分类查询错误，请稍候重试！
		  			...
		  			当前没有分类！
								...
								&nbsp;&nbsp;
								<a href="createnotetype.jsp">新建分类</a>
							</td>
						</tr>
					</table>
				</div>

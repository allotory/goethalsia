		...
		<form name="messageForm" id="oFormMessage" method="post">
			<div class="ContentWp">
				<div class="ContentThemeWp">
					<div class="gTitle">
						<b class="mTT"> </b> &nbsp;&nbsp;(当前页共&nbsp;
						<b id="oTotal">${fn:length(emailBeanList)}</b>&nbsp;封，&nbsp;
						<a
					...
					<div class="gToolbar gTbrTop">
						...
						<div class="Extra">
							<span class="Txt"><span class="Unable"><a
									href="goreceive2.do?pageNo=1">首页</a>
							</span>&nbsp;&nbsp; <span class="Unable"><a
									href="goreceive2.do?pageNo=${receivePageNo - 1 }">上页</a>
							</span> &nbsp;&nbsp; <span class="Unable"> <a
									href="goreceive2.do?pageNo=${receivePageNo + 1 }">下页</a>
							</span>&nbsp;&nbsp; <span class="Unable"><a
									href="goreceive2.do?pageNo=${receiveTotalPages }">末页</a>
							</span> </span>
												...
												<tr class="I_Mark0" align="left">
													...
													<td class="Ibx_Td_Chkbx">
														<input id="checked" name="mid" type="checkbox"
															title="选择/不选" value="${t.email.emailid }" />
													</td>
													<c:choose>

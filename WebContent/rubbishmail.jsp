...
.fTip {
	...
	{ if(confirm("是否将此封邮件删除?（删除不能恢复！）")){
	   document.messageForm.action="rubbishmaildeleting.do?emailid=<%=emailid%>"; 
				...
				<div class="ContentThemeWp">
					...
					<logic:present name="rubbishEmailBeanList" scope="session">
						...
						<logic:notEmpty name="rubbishEmailBeanList">
							<%
								List<EmailBean> rubbishEmailBeanList = (List<EmailBean>) request
												.getSession().getAttribute("rubbishEmailBeanList");
										...
										for (Iterator<EmailBean> i = rubbishEmailBeanList
												.iterator(); i.hasNext();) {
											EmailBean eb = i.next();

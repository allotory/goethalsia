...
{   
	...
	<%
		...
		if (email.getRecipients() == null || email.getRecipients() == "") {
			email.setRecipients("");
		}
		...
		for (Iterator<Contact> i = contactList.iterator(); i.hasNext();) {
			...
			if (contact.getContactemail().equals(email.getRecipients())) {
				break;
			} else {
				contact = null;
			}
	...
	<body style="margin-left: 0pt; margin-top: 0pt">
		...
		<form name="form1" method="post">
			...
			<div class="gCBgWp" style="margin-left: 5pt; margin-top: 5pt">
				<div class="Read_T">
					<table class="rTable"
						style="margin-left: 25px; padding-left: 98px; padding-top: 2px">
						<tr valign="top">
						...
						<tr valign="top">
							...
							<td colspan="2" style="padding-top: 5px">
								<input type="text" class="login_table_text1_input"
									...
									value="<%=email.getRecipients()%>" name="recipients" size="90" />
							</td>
						</tr>
					</table>
						...
						<table class="rTable">
							<tr valign="top">
								...
								<td colspan="2" style="padding-top: 5px">
									<input type="text" class="login_table_text1_input"
										style="font-weight: normal; font-family: Verdana, Arial, Helvetica, sans-serif"
										value="<%=email.getSubject()%>" name="subject" size="100" />
								</td>
							</tr>
							<tr valign="top">
							...
							<tr valign="top">
								<td align="left" colspan="3" style="padding-left: 4px">
									<fieldset
										...
										<%
											for (Iterator<Attachment> i = attachmentList.iterator(); i
														.hasNext();) {
													Attachment attachment = i.next();
													out
															.println(attachment.getAttachmentname()
																	+ " &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='attachDownload.jsp?attachmentid="
																	+ attachment.getAttachmentid()
																	+ "'>下载</a><input type='hidden' name='attach' value='"
